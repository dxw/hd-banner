...
class HDBanner {
	...
	public function banner_message_callback() {
		printf(
			'<input class="regular-text" type="text" name="hd_banner_options[banner_message]" id="banner_message" value="%s">',
			isset( $this->hd_banner_options['banner_message'] ) ? esc_attr( $this->hd_banner_options['banner_message']) : ''
		);
	}
	...
	public function background_colour_callback() {
		printf(
			'<input class="regular-text" type="text" name="hd_banner_options[background_colour]" id="background_colour" value="%s">',
	...
	public function text_colour_callback() {
		printf(
			'<input class="regular-text" type="text" name="hd_banner_options[text_colour]" id="text_colour" value="%s">',
	...
	public function link_colour_callback() {
		printf(
			'<input class="regular-text" type="text" name="hd_banner_options[link_colour]" id="link_colour" value="%s">',
 ...
 * $extra_styles = $hd_banner_options['extra_styles']; // Extra Styles
 */
